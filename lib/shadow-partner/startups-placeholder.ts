...
>[] = [
	...
	},
	{
		...
		email: "max@ironveil.io",
		founderLinkedIn: "https://linkedin.com/in/maxbohm-auth",
		description:
			"Auth and RBAC for agent-to-agent calls — capability-based access control for autonomous agent meshes.",
		source: SourceType.GITHUB,
		sourceUrl: "https://github.com/ironveil/ironveil",
		scrapedAt: daysAgo(0),
		confidenceScore: 0.92,
		thesisReasoning:
			"Agent-to-agent authorization is the emerging attack surface for agentic systems — nobody has solved this cleanly yet. Very high thesis fit.",
		status: PipelineStatus.SCANNED,
		draftedEmail: null,
		sentAt: null,
	},
...
export function getStartupsPlaceholder(organizationId: string): PlaceholderStartup[] {
