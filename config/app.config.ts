...
export const appConfig = {
	appName: "Backer",
	description:
		"Autonomous dual-sided deal intelligence and high-signal outreach execution networks. Simplifying capital discovery for high-conviction founders and breakout investment teams.",
	baseUrl: getBaseUrl(),
