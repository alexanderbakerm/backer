...
export const billingConfig = {
	...
	plans: {
		...
		free: {
			id: "free",
			name: "Free Tier",
			description: "For single operators exploring metrics",
			isFree: true,
			features: [
				"1 Active Vector Search",
				"Standard Web Parsing",
				"Local Ollama integration",
				"Up to 5 manual drafts / week",
			],
			limits: {
				maxMembers: 3,
				maxStorage: 1, // GB
		...
		pro: {
			id: "pro",
			name: "Pro Tier",
			description: "For active founders & angel investors",
			recommended: true,
			features: [
				"1 Continuous Shadow Agent",
				"Full Crunchbase & X scrapers",
				"Automated pipeline outbox",
				"Unlimited AI drafts",
			],
			limits: {
		...
		lifetime: {
			...
			description: "For institutional VC funds and scaling labs",
			features: [
				"Multi-agent parallel execution loops",
				"Priority Bright Data proxies",
				"Dedicated Z.ai / GLM-5.1 reasoning contexts",
				"Lifetime database state updates",
			],
			limits: {
				maxMembers: -1,
				maxStorage: 100,
...
export const creditCosts = {
	...
	// TokenRouter-prefixed models (active chat models)
	"openai/gpt-4o-mini": {
		input: 1, // ~$0.001/1K ($0.15/1M)
		output: 6, // ~$0.006/1K ($0.60/1M)
	},
	"deepseek/deepseek-v3.2": {
		input: 1, // ~$0.0003/1K ($0.27/1M — very cost-efficient)
		output: 2, // ~$0.001/1K ($1.10/1M)
	},
	"openai/gpt-5.4": {
		input: 25, // ~$0.025/1K (~$2.50/1M)
		output: 100, // ~$0.10/1K (~$10/1M)
	},
	"anthropic/claude-opus-4.7": {
		input: 150, // ~$0.15/1K ($15/1M)
		output: 750, // ~$0.75/1K ($75/1M)
	},
...
export const chatModels = [
	...
	{
		id: "deepseek/deepseek-v3.2" as const,
		name: "DeepSeek V3",
		description: "Smart & cost-efficient",
		tier: "standard" as const,
		provider: "deepseek" as const,
	},
	{
		id: "openai/gpt-5.4" as const,
		name: "GPT-5.4",
	...
	{
		id: "anthropic/claude-opus-4.7" as const,
...
export const DEFAULT_CHAT_MODEL: ChatModelId = "openai/gpt-4o-mini";
