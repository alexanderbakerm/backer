...
export function StatsSection() {
	const stats: Stat[] = [
		{
			value: "14.2M+",
			label: "Data Points Scraped",
			description: "Real-time builder activity tracking",
		},
		{
			value: "94.6%",
			label: "AI Match Accuracy",
			description: "Precise Z.ai thesis evaluation layers",
		},
		{
			value: "4.8x",
			label: "Inbound Velocity",
			description: "Accelerated founder-to-investor meetings",
		},
		{
			value: "24/7",
			label: "Autonomous Operations",
			description: "Continuous background scanning loops",
		},
	];
			...
			<div className="mx-auto flex max-w-2xl flex-col gap-10 px-6 md:max-w-3xl lg:max-w-7xl lg:gap-16 lg:px-10">
				...
				<div className="flex max-w-2xl flex-col gap-6">
					<div className="flex flex-col gap-2">
						...
						>
							Trusted by operators on both sides of the table
						</h2>
					</div>
					<div className="text-base leading-7 text-marketing-fg-muted text-pretty">
						<p>
							From solo GPs running parallel sourcing lanes to founders
							orchestrating warm intros—your agents keep working while you
							sleep.
						</p>
					</div>
				</div>
