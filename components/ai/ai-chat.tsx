						...
						{isLoadingChat ? (
							...
							<div className="flex flex-1 flex-col items-center justify-center gap-4 text-center">
								...
								<Suggestions className="mt-4 flex-wrap justify-center">
									<Suggestion
										suggestion="Show me the top startups by confidence score"
										onClick={handleSendMessage}
									/>
									<Suggestion
										suggestion="Which startups have we already outreached to?"
										onClick={handleSendMessage}
									/>
									<Suggestion
										suggestion="Give me a pipeline overview"
										onClick={handleSendMessage}
									/>
									<Suggestion
										suggestion="Find startups sourced from GitHub"
										onClick={handleSendMessage}
									/>
								</Suggestions>
							</div>
